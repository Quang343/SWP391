...
public class StockOutDetailController {
    ...
    public ResponseEntity<Integer> getTotalProductsInStockOut(@PathVariable("id") Long stockOutId) {
        int totalQuantity = stockOutDetailService.countTotalProductsInStockOut(stockOutId);
