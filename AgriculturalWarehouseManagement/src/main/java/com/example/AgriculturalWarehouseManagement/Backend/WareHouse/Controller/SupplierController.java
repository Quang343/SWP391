package com.example.AgriculturalWarehouseManagement.Backend.WareHouse.Controller;
...
import com.example.AgriculturalWarehouseManagement.Backend.WareHouse.Service.SupplierService;
...
public class SupplierController {
    ...
    public ResponseEntity<SupplierDTO> getSupplierById(@PathVariable Integer supplierID) {
        ...
        return supplierDTO != null ? ResponseEntity.ok(supplierDTO) : ResponseEntity.notFound().build();
    }
